(() => {
    ...
    // assets/scripts/src/theme/components/mobileMenu.js
    var mobileMenu = () => {
        $(".menu-toggle").click(function(e) {
            e.stopPropagation();
            $(this).toggleClass("is-active");
            setTimeout(() => {
                document.body.classList.toggle("scroll-lock", this.classList.contains("is-active"));
            });
        });
    ...
    // assets/scripts/src/theme/components/desktopMenu.js
    var desktopMenu = () => {
    ...
    // assets/scripts/src/theme/components/parallax.js
    var import_rellax = __toModule(require_rellax());
    var parallax = () => {
        ...
        if ($els.length) {
            ...
            new import_rellax.default(".rellax", {
                speed: 3,
                center: true
            });
        }
    ...
    // assets/scripts/src/theme/components/gforms.js
    var gforms = () => {
        $(".gfield_select").closest(".gfield").addClass("has-select");
        $(".ginput_container_textarea").closest(".gfield").addClass("has-textarea");
        $("input:not([type=radio]):not([type=checkbox]):not([type=file]):not([type=hidden])").closest(".gfield").addClass("has-text-input");
        $("input, textarea, select").on("change blur", function() {
            var $input = $(this);
